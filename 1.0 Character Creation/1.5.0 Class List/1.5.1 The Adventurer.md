...
They then use the usual full [Mage]({% link 1.0 Character Creation/1.5.0 Class List/1.5.12 The Mage.md %}) chart for hit dice, attack bonus, and Foci, and the spellcasting table for dual casters if both partial classes cast spells.
