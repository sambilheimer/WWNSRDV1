...
A Partial Mage is treated as a [Mage](1.5.0 Class List/1.5.12 The Mage), and gains the **Arcane Tradition** ability, allowing them to pick a magical tradition for their powers. That tradition’s abilities will be more limited for Partial Mages, however, as described under each of the paths.
...
They then use the usual full [Mage](1.5.0 Class List/1.5.12 The Mage) chart for hit dice, attack bonus, and Foci, and the spellcasting table for dual casters if both partial classes cast spells.
