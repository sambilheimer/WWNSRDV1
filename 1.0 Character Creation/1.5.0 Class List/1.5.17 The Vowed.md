...
- **Unarmed Might**: Your unarmed attack damage increases as you gain levels, as noted on the chart.
  You may add your Punch skill to the damage done by these attacks as usual, but [Foci]({% link 1.0 Character Creation/1.6.0 Foci.md %}) such as Unarmed Combatant that replace or improve your usual Punch damage do not apply to you.
