...
Usable only by [Mage](1.5.0 Class List/1.5.12 The Mage) heroes who would otherwise be prevented from casting spells or using arts while armored, this focus reflects special training in channeling magic through the hindering materials of conventional armor.
