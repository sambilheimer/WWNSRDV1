...
Usable only by [Mage]({% link 1.0 Character Creation/1.5.0 Class List/1.5.12 The Mage.md %}) heroes who would otherwise be prevented from casting spells or using arts while armored, this focus reflects special training in channeling magic through the hindering materials of conventional armor.
...
This focus cannot be taken by heroes with the [Mage]({% link 1.0 Character Creation/1.5.0 Class List/1.5.12 The Mage.md %}) or partial mage classes.
...
This Focus cannot be taken by [Mage]({% link 1.0 Character Creation/1.5.0 Class List/1.5.12 The Mage.md %}) or Partial Mages.
...
Once per scene, your efforts count as an **Extirpate Arcana** spell against the trap or hazard, cast as if a [Mage]({% link 1.0 Character Creation/1.5.0 Class List/1.5.12 The Mage.md %}) of twice your level, with any relevant skill check being Int/Notice or Dex/Notice.
