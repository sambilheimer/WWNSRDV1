...
The [Mage](1.5.0 Class List/1.5.12 The Mage) opens up their mind to the presence of occult energies.
...
The [Mage](1.5.0 Class List/1.5.12 The Mage) targets a visible, normal, non-magical animal or insect, obtaining temporary control of the beast and the ability to share its senses.

The animal gains a telepathic bond with the caster, obeying any non-suicidal command and allowing the [Mage](1.5.0 Class List/1.5.12 The Mage) to perceive everything it perceives.
...
The [Mage](1.5.0 Class List/1.5.12 The Mage) must focus to share the beast’s senses, requiring a Main Action and leaving the [Mage](1.5.0 Class List/1.5.12 The Mage) unable to act physically while so focused.

The spell lasts until the [Mage](1.5.0 Class List/1.5.12 The Mage) releases the beast, it is dispelled, or it is cast again.
