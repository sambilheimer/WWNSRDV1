...
The beast will not fight for the caster, but can perform complex actions entirely out of character for it while under the [Mage's]({% link 1.0 Character Creation/1.5.0 Class List/1.5.12 The Mage.md %}) control.
